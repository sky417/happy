...
export class ApiClient {
   ...
   */
  async registerVendorToken(vendor: 'openai' | 'anthropic' | 'gemini' | 'github', apiKey: any): Promise<void> {
    try {
      const response = await axios.post(
   ...
   */
  async getVendorToken(vendor: 'openai' | 'anthropic' | 'gemini' | 'github'): Promise<any | null> {
    try {
