...
<h1 align="center">
  Mobile and Web Client for Claude Code, Codex & Copilot CLI
</h1>

<h4 align="center">
Use Claude Code, Codex or Copilot CLI from anywhere with end-to-end encryption.
</h4>
...
<h3 align="center">
Step 3: Start using `happy` instead of `claude`, `codex` or `copilot`
</h3>
...
- 📱 **Mobile access to Claude Code, Codex and Copilot CLI** - Check what your AI is building while away from your desk
- 🔔 **Push notifications** - Get alerted when Claude Code, Codex and Copilot CLI needs permission or encounters errors
...
- **[Happy CLI](https://github.com/slopus/happy/tree/main/packages/happy-cli)** - Command-line interface for Claude Code, Codex and Copilot CLI
